...
Xtrain_path = hf_hub_download(
    repo_id="ArakdeeD71/tourism-analysis",
    filename="Xtrain.csv",
    repo_type="dataset")
...
model_path = "best_tourism_prodtaken_model_v1.joblib"
...
api.upload_file(
    path_or_fileobj="best_tourism_prodtaken_model_v1.joblib",
    path_in_repo="best_tourism_prodtaken_model_v1.joblib",
    repo_id=repo_id,
    repo_type=repo_type,
)
